...
class leadMarketListViewController extends baseViewController
{
    private $table = 'lead_market';
    ...
    /**
     * @Route('/app/lead_markets', name='app_lead_markets')
     */
    public function itemslistAction()
    {
//$this->myfile = fopen(APP_ROOT_PATH.'/var/logs/leadMarketsListViewController_'.__FUNCTION__.'.txt', 'w') or die('Unable to open file!');
//$txt = '====================== '.__METHOD__.' start ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
//$txt = 'this->pagination ========>'.PHP_EOL;fwrite($this->myfile, $txt);
//fwrite($this->myfile, print_r($this->pagination, TRUE));
        $this->list_filters['name']['caption'] = $this->lang['LEAD_MARKET_NAME'];
        $this->list_filters['name']['placeholder'] = $this->lang['LEAD_MARKET_NAME'];
...
//fclose($this->myfile);
        return $this->twig->render('app/'.$this->session->config['app_skin'].'/'.$this->folder.'/leadMarkets.html.twig', array(
