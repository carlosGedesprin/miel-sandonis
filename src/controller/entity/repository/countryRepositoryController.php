 ...
 * @package entity
 */
trait countryRepositoryController
{
    /**
     *
     * Get all countries for lists and selects
     *
     */
...
//$txt = 'Countries from api =========='.PHP_EOL; fwrite($this->myfile, $txt);
...
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
    ...
    /**
     *
     * Check if country can be populated to db
     *
     */
...
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
    ...
    /**
     *
     * Check if country can be deleted from db
     *
     */
