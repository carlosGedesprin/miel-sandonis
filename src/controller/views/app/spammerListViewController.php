...
class spammerListViewController extends baseViewController
{
    private $table = 'spammer';
    ...
    /**
     * @Route('/app/spammers', name='app_spammers')
     */
    public function itemslistAction()
    {
//$this->myfile = fopen(APP_ROOT_PATH.'/var/logs/spammerListViewController_'.__FUNCTION__.'.txt', 'w') or die('Unable to open file!');
//$txt = 'spammerListViewController '.__FUNCTION__.' start ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
//$txt = 'this->pagination ========>'.PHP_EOL;fwrite($this->myfile, $txt);
//fwrite($this->myfile, print_r($this->pagination, TRUE));
//$txt = 'spammerListViewController '.__FUNCTION__.' end ==============================================================='.PHP_EOL;fwrite($this->myfile, $txt);
//fclose($this->myfile);
        $this->list_filters['name']['caption'] = $this->lang['SPAMMER_NAME'];
        $this->list_filters['name']['placeholder'] = $this->lang['SPAMMER_NAME'];
        ...
        return $this->twig->render('app/'.$this->session->config['app_skin'].'/'.$this->folder.'/spammers.html.twig', array(
