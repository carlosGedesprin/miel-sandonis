...
class blogArticleDeleteViewController extends baseViewController
{
    ...
    /**
     * @Route("/app/blog_article/delete/id", name="app_blog_article_delete")
     *
    ...
    {
//$this->myfile = fopen(APP_ROOT_PATH.'/var/logs/blogArticleDeleteViewController_'.__FUNCTION__.'.txt', 'w') or die('Unable to open file!');
//$txt = '====================== '.__METHOD__.' start ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);

        $form_action = $this->folder.'/blog_article/delete';
        ...
        if ( !isset( $vars['id']) || $vars['id'] == '' || $vars['id'] == '0' )
        {
            $_SESSION['alert'] = array(
                'type'          => 'danger',
                'message'       => $this->lang['ERR_BLOG_ARTICLE_NOT_EXISTS'],
        ...
        $files = array(
            ...
            '2' => array (
                ...
                'file_name' => '',
                'file_extension' => '',
                'file_allowed_extensions' => array('gif', 'jpeg', 'jpg', 'png', 'avif'),
                'file_link' => '',
                'image_size_height' => '100',
                'image_size_width' => '100',
                'image_error_text' => $this->lang['ERR_BLOG_ARTICLE_IMAGE_NEEDED'],
        ...
        if ( $data['submit'] )
        {
            ...
            */
            ...
            if ( sizeof( $blog_articles ) )
            {
                $error_ajax[] = array (
                    'dom_object' => [],
                    'msg' => $this->lang['ERR_BLOG_ARTICLE_HAS_ARTICLES'],
                );
            }
            */
            ...
            {
                $this->logger->info('==============='.__METHOD__.' Blog article '.$vars['id'].' | User '.$this->user.' ===================================================');
...
//$txt = '================= Delete from destiny folder end =============================================='.PHP_EOL; fwrite($this->myfile, $txt);
                ...
                $response['status'] = 'OK';
                $response['msg'] = $this->lang['BLOG_ARTICLE_DELETED'];
