...
class N8NWarmIPEmailController extends baseController
{
    use repository\N8NWarmIPEmailRepositoryController;

    private $table = 'n8n_warm_ip_email';
    private $reg = array(
                            'id'          => '',
                            'account'     => NULL,
                            'date_sent'   => NULL,
...
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
    ...
    public function setDateSent( $date_sent ) { $this->reg['date_sent'] = $date_sent;  }
    public function setWarmEmail( $warm_email ) { $this->reg['warm_email'] = $warm_email;  }
    public function setSubject( $subject ) { $this->reg['subject'] = $subject;  }
    public function setBody( $body ) { $this->reg['body'] = $body;  }
    ...
    public function getDateSent() { return $this->reg['date_sent']; }
    public function getSubject() { return $this->reg['subject']; }
    public function getWarmEmail() { return $this->reg['warm_email']; }
    public function getBody() { return $this->reg['body']; }
    ...
    {
//$txt = '====================== '.__METHOD__.' start ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
        $this->reg['date_sent'] = ( empty($this->reg['date_sent']) )? NULL : DateTime::createFromFormat('Y-m-d H:i:s', $this->reg['date_sent'], new DateTimeZone($this->session->config['time_zone']));
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
    }
    ...
    {
//$txt = '====================== '.__METHOD__.' start ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
        $this->reg['date_sent'] = ( empty($this->reg['date_sent']) )? NULL : $this->reg['date_sent']->format('Y-m-d H:i:s');
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
    }
}