...
class solutionDeleteViewController extends baseViewController
{
    ...
    /**
     * @Route("/app/solution/delete/id", name="app_solution_delete")
     *
    ...
    {
//$this->myfile = fopen(APP_ROOT_PATH.'/var/logs/solutionDeleteViewController_'.__FUNCTION__.'.txt', 'w') or die('Unable to open file!');
//$txt = '====================== '.__METHOD__.' start ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);

        $form_action = $this->folder.'/solution/delete';
        ...
        if ( !isset( $vars['id']) || $vars['id'] == '' || $vars['id'] == '0' )
        {
            $_SESSION['alert'] = array(
                'type'          => 'danger',
                'message'       => $this->lang['ERR_SOLUTION_NOT_EXISTS'],
...
//$txt = '================= Getting file names from view end =============================================='.PHP_EOL; fwrite($this->myfile, $txt);
        ...
        if ( $data['submit'] )
        {
            ...
            */
            ...
            {
                $this->logger->info('==============='.__METHOD__.' Solution '.$vars['id'].' | User '.$this->user.' ===================================================');
...
//$txt = '================= Delete from destiny folder end =============================================='.PHP_EOL; fwrite($this->myfile, $txt);
                ...
                $response['status'] = 'OK';
                $response['msg'] = $this->lang['SOLUTION_DELETED'];
