...
{
    use repository\invoiceLineRepositoryController;

    private $table = 'invoice_line';
    private $reg = array(
                            'id'           => '',
                            'invoice'      => NULL,
                            'item'         => NULL,
...
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
    ...
    public function setItem( $item ) { $this->reg['item'] = $item;  }
    public function setUnits( $units ) { $this->reg['units'] = $units;  }
    public function setProduct( $product ) { $this->reg['product'] = $product;  }
    ...
    public function getItem() { return $this->reg['item']; }
    public function getUnits() { return $this->reg['units']; }
    public function getProduct() { return $this->reg['product']; }
...
//$txt = '====================== '.__METHOD__.' start ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
        ...
        $this->reg['product'] = ( empty($this->reg['product']) )? NULL : $this->reg['product'];

        $this->reg['units'] = ( empty($this->reg['units']) )? '1' : $this->reg['units'];
        $this->reg['price'] = ( empty($this->reg['price']) )? '0' : $this->reg['price'];
        $this->reg['amount'] = ( empty($this->reg['amount']) )? '0' : $this->reg['amount'];
        $this->reg['discount'] = ( empty($this->reg['discount']) )? '0' : $this->reg['discount'];
        $this->reg['total'] = ( empty($this->reg['total']) )? '0' : $this->reg['total'];
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
    }
}
