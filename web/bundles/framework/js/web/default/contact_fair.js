...
(function($) {
    ...
    $("#footer_contact_form_btn_submit").click(function(e) {
        ...
        $("#footer_contact_form_btn_submit").css('display', 'none');
        ...
        $.ajax({
            ...
            .done( function( response ) {
                ...
                else if( json_resp.status === 'KO' )
                {
                    ...
                    $("#footer_contact_form_btn_submit").css('display', 'flex');
                    ...
                    $("html, body").animate({scrollTop: $("#error_messages").offset().top}, 1500);
                }
    ...
    function cleanMessagesAndErrors()
    {
        ...
        $('.input_errors').empty();
        $('#contact_fair_form_form').find( 'input' ).removeClass('is_wrong');
        $('#contact_fair_form_form').find( 'textarea' ).removeClass('is_wrong');
    }
})(jQuery);
