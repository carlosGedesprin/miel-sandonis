...
class paymentRedsysController extends baseViewController
{
    /**
     *
     * Web payment
...
//$txt = '********** Va payá ***********'.PHP_EOL; fwrite($this->myfile, $txt);
...
//$txt = 'paymentController chargewebpayAction start ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt); $txt = PHP_EOL; fwrite($this->myfile, $txt);
//$txt = 'POST sent to Tonepay : '.PHP_EOL; fwrite($this->myfile, $txt); fwrite($this->myfile, print_r($data, TRUE));
//fwrite($this->myfile, print_r($reg, TRUE));
//$txt = 'web chargeController chargewebpayAction end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
//fclose($this->myfile);
...
//$txt = 'paymentController setResultProvAction start '.$now.'==============================================================='.PHP_EOL; fwrite($this->myfile, $txt); $txt = PHP_EOL; fwrite($this->myfile, $txt);
//$txt = 'POST : '.PHP_EOL; fwrite($this->myfile, $txt); fwrite($this->myfile, print_r($_POST, TRUE));
//$txt = 'reg : '.PHP_EOL; fwrite($this->myfile, $txt); fwrite($this->myfile, print_r($reg, TRUE));

        if ( $reg['amount'] > 0 )   $reg['amount'] = $reg['amount'] / 100;  // Received in pennies

        if ( $this->charge = $this->db->fetchOne( 'charge', '*', ['reference' => $reg['charge']] ) )
        {
//$txt = 'Charge ======> ' . $this->charge['id'] . PHP_EOL; fwrite($this->myfile, $txt);
...
//fclose($this->myfile);
    ...
    public function setResultAction( $vars )
    {
        $reg = array(
            ...
            //'createdby'   => '0',
            //'createddate' => (new DateTime("now", new DateTimeZone($this->session->config['time_zone'])))->format('Y-m-d H:i:s'),
...
*/
    ...
    {
//$this->myfile = fopen('debug_payment_'.$vars['reference'].'.txt', 'a+') or die('Unable to open file!');
//$txt = 'paymentController getChargePhoneAction start ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
//$txt = 'initial $vars :'.PHP_EOL; fwrite($this->myfile, $txt);
...
//$txt = PHP_EOL.'Response ========>'.$response.PHP_EOL;fwrite($this->myfile, $txt);
//$txt = 'paymentController getChargePhoneAction end ==============================================================='.PHP_EOL;fwrite($this->myfile, $txt);
//fclose($this->myfile);
