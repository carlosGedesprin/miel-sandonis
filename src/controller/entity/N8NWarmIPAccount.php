...
class N8NWarmIPAccount extends baseController
{
    use repository\N8NWarmIPAccountRepositoryController;
    use verifications\N8NWarmIPAccountVerificationController;
    ...
    /**
     *
     * Get n8n warm ip account from his id
     *
     */
