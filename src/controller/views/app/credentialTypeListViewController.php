...
class credentialTypeListViewController extends baseViewController
{
    private $table = 'credential_type';
    ...
    /**
     * @Route('/app/credential_types', name='app_credential_types')
     */
    public function itemslistAction()
    {
//$this->myfile = fopen(APP_ROOT_PATH.'/var/logs/credentialTypeListViewController_'.__FUNCTION__.'.txt', 'w') or die('Unable to open file!');
//$txt = '====================== '.__METHOD__.' start ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
//$txt = 'this->pagination ========>'.PHP_EOL;fwrite($this->myfile, $txt);
//fwrite($this->myfile, print_r($this->pagination, TRUE));
        $this->list_filters['name']['caption'] = $this->lang['CREDENTIAL_TYPE_NAME'];
        $this->list_filters['name']['placeholder'] = $this->lang['CREDENTIAL_TYPE_NAME'];
...
//fclose($this->myfile);
        return $this->twig->render('app/'.$this->session->config['app_skin'].'/'.$this->folder.'/credentialTypes.html.twig', array(
