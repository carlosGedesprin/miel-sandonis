...
{
    use repository\bankAccountRepositoryController;
...
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
    ...
    /**
     *
     * Get bank account from his iban
     *
     */
    public function getRegbyIban( $iban )
    {
//$txt = '====================== '.__METHOD__.' start ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
//$txt = 'Iban ==========> ('.$iban.')'.PHP_EOL; fwrite($this->myfile, $txt);
        if ( !$iban ) return false;

        $filter = array( 'iban' => $iban );
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
        return $this->getRegFromDB( $filter );
    }
     ...
     *
     */
    public function getRegbyDefault()
    {
//$txt = '====================== '.__METHOD__.' start ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
...
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
    ...
    public function setNumber( $number ) { $this->reg['number'] = $number; }
 ...
 */
    ...
    public function getNumber() { return $this->reg['number']; }
