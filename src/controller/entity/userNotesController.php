...
{
    use repository\userNotesRepositoryController;

    private $table = 'user_notes';
    private $reg = array(
                            'id'                => '',
                            'user'              => NULL,
                            'group'             => '',
...
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
     ...
     *
     */
    public function getRegbyUserAndGroup( $user, $group )
    {
//$txt = '====================== '.__METHOD__.' start ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
//$txt = 'Id ==========> ('.$id.')'.PHP_EOL; fwrite($this->myfile, $txt);
        if ( !$user || $group ) return false;

        $filter = array( 'user' => $user, 'group' => $group );
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
        return $this->getRegFromDB( $filter );
    }
