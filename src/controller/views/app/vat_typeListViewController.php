...
class vat_typeListViewController extends baseViewController
{
    private $table = 'vat_type';
    ...
    /**
     * @Route('/app/vat_type', name='app_vat_type')
     */
    public function itemslistAction()
    {
//$this->myfile = fopen(APP_ROOT_PATH.'/var/logs/vat_typeListViewController_'.__FUNCTION__.'.txt', 'w') or die('Unable to open file!');
//$txt = 'vat_typeListViewController '.__FUNCTION__.' start ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
...
//fclose($this->myfile);
        $this->list_filters['name']['caption'] = $this->lang['VAT_TYPE_NAME'];
        $this->list_filters['name']['placeholder'] = $this->lang['VAT_TYPE_NAME'];
        ...
        return $this->twig->render('app/'.$this->session->config['app_skin'].'/'.$this->folder.'/vat_types.html.twig', array(
