...
class spammerDeleteViewController extends baseViewController
{
    ...
    /**
     * @Route("/app/spammer/delete/id", name="app_spammer_delete")
     *
     * @param POST
     *
    ...
    {
        $form_action = $this->folder.'/spammer/delete';
        ...
        if ( !isset( $vars['id']) || $vars['id'] == '' || $vars['id'] == '0' )
        {
            $_SESSION['alert'] = array(
                'type'          => 'danger',
                'message'       => $this->lang['ERR_SPAMMER_NOT_EXISTS'],
        ...
        if ( $data['submit'] )
        {
            ...
            */
            ...
            {
                $this->logger->info('==============='.__METHOD__.' Spammer '.$vars['id'].' | User '.$this->user.' ===================================================');
                ...
                $response['status'] = 'OK';
                $response['msg'] = $this->lang['SPAMMER_DELETED'];
