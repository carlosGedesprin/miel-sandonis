...
class ragDocumentController extends baseController
{
    use repository\ragDocumentRepositoryController;
    use verifications\ragDocumentVerificationController;

    private $table = 'rag_document';
    private $reg = array(
                        'id'               => '',
                        'rag_document_key' => NULL,
                        'rag'              => NULL,
                        'name'             => NULL,
                        'file_name'        => NULL,
                        'extension'        => NULL,
...
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
     ...
     *
     */
    public function getRegbyRagDocumentKey( $key )
    {
//$txt = '====================== '.__METHOD__.' start ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
//$txt = 'Key ==========> ('.$key.')'.PHP_EOL; fwrite($this->myfile, $txt);
        if ( !$key ) return false;

        $filter = array( 'rag_document_key' => $key  );
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
        return $this->getRegFromDB( $filter );
    }
...
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
    ...
    public function setRagDocumentKey( $rag_document_key ) { $this->reg['rag_document_key'] = $rag_document_key; }
    public function setRag( $rag ) { $this->reg['rag'] = $rag; }
    public function setName( $name ) { $this->reg['name'] = $name; }
    public function setFileName( $file_name ) { $this->reg['file_name'] = $file_name; }
    public function setExtension( $extension ) { $this->reg['extension'] = $extension; }
    public function setDateReg( $datereg ) { $this->reg['date_reg'] = $datereg; }
    public function setStatus( $status ) { $this->reg['status'] = $status; }
    ...
    public function getRagDocumentKey() { return $this->reg['rag_document_key']; }
    public function getRag() { return $this->reg['rag']; }
    public function getName() { return $this->reg['name']; }
    public function getFileName() { return $this->reg['file_name']; }
    public function getExtension() { return $this->reg['extension']; }
    public function getDateReg() { return $this->reg['date_reg']; }
    public function getStatus() { return $this->reg['status']; }
...
//$txt = '====================== '.__METHOD__.' start ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
        ...
        $this->reg['status'] = ( empty($this->reg['status']) )? '0' : $this->reg['status'];
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
    }
}