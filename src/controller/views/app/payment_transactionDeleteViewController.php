...
class payment_transactionDeleteViewController extends baseViewController
{
    ...
    /**
     * @Route("/app/payment_transaction/delete/id", name="app_payment_transaction_delete")
     *
     * @param POST
     *
    ...
    {
        $form_action = $this->folder.'/payment_transaction/delete';
        ...
        if ( !isset( $vars['id']) || $vars['id'] == '' || $vars['id'] == '0' )
        {
            $_SESSION['alert'] = array(
                'type'          => 'danger',
                'message'       => $this->lang['ERR_PAYMENT_TRANSACTION_NOT_EXISTS'],
        ...
        if ( $data['submit'] )
        {
            ...
            */
            ...
            if ( !sizeof( $error_ajax ) )
            {
                ...
                $response['status'] = 'OK';
                $response['msg'] = $this->lang['PAYMENT_TRANSACTION_DELETED'];
