...
class blogAuthorListViewController extends baseViewController
{
    ...
    /**
     * @Route('/app/blog_authors', name='app_blog_authors')
     */
    public function itemslistAction()
    {
//$this->myfile = fopen(APP_ROOT_PATH.'/var/logs/blogAuthorsListViewController_'.__FUNCTION__.'.txt', 'w') or die('Unable to open file!');
//$txt = '====================== '.__METHOD__.' start ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
//$txt = 'this->pagination ========>'.PHP_EOL;fwrite($this->myfile, $txt);
//fwrite($this->myfile, print_r($this->pagination, TRUE));
        $this->list_filters['name']['caption'] = $this->lang['BLOG_AUTHOR_NAME'];
        $this->list_filters['name']['placeholder'] = $this->lang['BLOG_AUTHOR_NAME'];
...
//fclose($this->myfile);
        return $this->twig->render('app/'.$this->session->config['app_skin'].'/'.$this->folder.'/blog_authors.html.twig', array(
