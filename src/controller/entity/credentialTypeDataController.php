...
class credentialTypeDataController extends baseController
{
    use repository\credentialTypeDataRepositoryController;

    private $table = 'credential_type_data';
    private $reg = array(
                            'id'              => '',
                            'name'            => NULL,
    ...
    /**
     *
     * Get Credential Type Data from his id
     *
     */
...
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
    ...
    public function setField( $field ) { $this->reg['field'] = $field;  }
    ...
    public function getField() { return $this->reg['field']; }
