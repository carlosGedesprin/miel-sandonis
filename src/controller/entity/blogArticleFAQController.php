...
class blogArticleFAQController extends baseController
{
    use repository\blogArticleFAQRepositoryController;

    private $table = 'blog_article_faq';
    private $reg = array(
                            'id'           => '',
                            'article'      => NULL,
                            'lang_code_2a' => NULL,
...
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
    ...
    public function setQuestion( $question ) { $this->reg['question'] = $question; }
    public function setReply( $reply ) { $this->reg['reply'] = $reply; }
    ...
    public function getQuestion() { return $this->reg['question']; }
    public function getReply() { return $this->reg['reply']; }
...
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
    ...
    {
//$txt = '====================== '.__METHOD__.' start ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
        $this->reg['question'] = ( empty ( $this->reg['question'] ) )? NULL : $this->reg['question'];
