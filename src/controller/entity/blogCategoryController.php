...
{
    use repository\blogCategoryRepositoryController;
...
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
    ...
    /**
     *
     * Get blog category from his slug
     *
     */
    public function getRegbySlug( $slug )
    {
//$txt = '====================== '.__METHOD__.' start ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
//$txt = 'Slug ==========> ('.$slug.')'.PHP_EOL; fwrite($this->myfile, $txt);
...
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
    ...
    public function setMetadescription( $metadescription ) { $this->reg['metadescription'] = $metadescription;  }
    public function setSlug( $slug ) { $this->reg['slug'] = $slug;  }
    public function setPicture( $picture ) { $this->reg['picture'] = $picture;  }
    public function setPictureAltText( $picture_alt_text ) { $this->reg['picture_alt_text'] = $picture_alt_text;  }
    public function setOrdinal( $ordinal ) { $this->reg['ordinal'] = $ordinal;  }
    public function setFeatured( $featured ) { $this->reg['featured'] = $featured;  }
    ...
    public function getMetadescription() { return $this->reg['metadescription']; }
    public function getSlug() { return $this->reg['slug']; }
    public function getPicture() { return $this->reg['picture']; }
    public function getPictureAltText() { return $this->reg['picture_alt_text']; }
    public function getOrdinal() { return $this->reg['ordinal']; }
    public function getFeatured() { return $this->reg['featured']; }
...
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
    ...
    {
//$txt = '====================== '.__METHOD__.' start ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
        $this->reg['ordinal'] = ( empty ( $this->reg['ordinal'] ) )? '5' : $this->reg['ordinal'];
//fwrite($this->myfile, print_r($this->getReg(), TRUE)); $txt = PHP_EOL; fwrite($this->myfile, $txt);
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
    }
}
