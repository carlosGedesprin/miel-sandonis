...
class blogArticleLangController extends baseController
{
    use repository\blogArticleLangRepositoryController;

    private $table = 'blog_article_lang';
    private $reg = array(
                            'id'               => '',
                            'article'          => NULL,
                            'lang_code_2a'     => NULL,
...
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
    ...
    /**
     *
     * Get blog article from his slug
     *
     */
...
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
     ...
     *
     */
    public function getRegbyArticleLang( $article, $lang_code_2a )
    {
//$txt = '====================== '.__METHOD__.' start ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
...
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
    ...
    public function setArticle( $article ) { $this->reg['article'] = $article;  }
    ...
    public function setFaqTitle( $faq_title ) { $this->reg['faq_title'] = $faq_title;  }
    ...
    public function getArticle() { return $this->reg['article']; }
    ...
    public function getFaqTitle() { return $this->reg['faq_title']; }
