...
class leadListViewController extends baseViewController
{
    private $table = 'lead';
    ...
    /**
     * @Route('/app/leads', name='app_leads')
     */
    public function itemslistAction()
    {
//$this->myfile = fopen(APP_ROOT_PATH.'/var/logs/LEADListViewController_'.__FUNCTION__.'.txt', 'a+') or die('Unable to open file!');
//$txt = '====================== '.__METHOD__.' start ==============================================================='.PHP_EOL;fwrite($this->myfile, $txt);
//$txt = 'this->pagination ========>'.PHP_EOL;fwrite($this->myfile, $txt);
//fwrite($this->myfile, print_r($this->pagination, TRUE));

        $this->list_filters['name']['caption'] = $this->lang['LEAD_NAME'];
        $this->list_filters['name']['placeholder'] = $this->lang['LEAD_NAME'];
        $this->list_filters['email']['caption'] = $this->lang['LEAD_EMAIL'];
        $this->list_filters['email']['placeholder'] = $this->lang['LEAD_EMAIL'];
...
//fclose($this->myfile);
        return $this->twig->render('app/'.$this->session->config['app_skin'].'/'.$this->folder.'/leads.html.twig', array(
