...
{
    use repository\paymentTypeRepositoryController;
...
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
    ...
    /**
     *
     * Get payment type from his name
     *
     */
...
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
    ...
    public function setScript( $script ) { $this->reg['script'] = $script;  }
    public function setMethod( $method ) { $this->reg['method'] = $method;  }
    ...
    public function getScript() { return $this->reg['script']; }
    public function getMethod() { return $this->reg['method']; }
