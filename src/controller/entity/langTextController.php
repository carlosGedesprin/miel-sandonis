...
{
    use repository\langTextRepositoryController;
    use verifications\langTextVerificationController;
...
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
    ...
    /**
     *
     * Get lang text from his lang key
     *
     */
    public function getRegbyLangKey( $lang_key )
    {
//$txt = '====================== '.__METHOD__.' start ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
//$txt = 'Lang key ==========> ('.$lang_key.')'.PHP_EOL; fwrite($this->myfile, $txt);
        if ( !$lang_key ) return false;

        $filter = array( 'lang_key' => $lang_key );
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
        return $this->getRegFromDB( $filter );
    }
...
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
    ...
    public function setLangKey( $langkey ) { $this->reg['lang_key'] = $langkey;  }
    public function setContext( $context ) { $this->reg['context'] = $context;  }
    ...
    public function getContext() { return $this->reg['context']; }
...
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
    ...
    {
//$txt = '====================== '.__METHOD__.' start ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
        $this->reg['lang_key'] = ( empty($this->reg['lang_key']) )? NULL : $this->reg['lang_key'];
        $this->reg['context'] = ( empty($this->reg['context']) )? NULL : $this->reg['context'];
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
    }
}