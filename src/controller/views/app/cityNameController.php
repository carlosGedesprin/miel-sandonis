...
class cityNameController extends baseController
{
    use repository\cityNameRepositoryController;

    private $table = 'city_name';
    private $reg = array(
                            'id'            => '',
                            'city_code'     => NULL,
                            'lang_2a'       => NULL,
...
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
    ...
    /**
     *
     * Get city name from his city code and lang_2a
     *
     */
    public function getRegbyCityCodeAndLang2a( $city_code, $lang_2a )
    {
//$txt = '====================== '.__METHOD__.' start ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
//$txt = 'City Code ==========> '.$city_code.' Lang '.$lang_2a.PHP_EOL; fwrite($this->myfile, $txt);
        if ( !$city_code || !$lang_2a ) return false;
...
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
    ...
    public function setCityCode( $city_code ) { $this->reg['city_code'] = $city_code;  }
    ...
    public function getCityCode() { return $this->reg['city_code']; }
