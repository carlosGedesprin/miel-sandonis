...
class orlController extends baseController
{
    use repository\orlRepositoryController;
...
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
    ...
    public function setEntity( $entity ) { $this->reg['entity'] = $entity;  }
    public function setOld( $old ) { $this->reg['old'] = $old;  }
    public function setNew( $new ) { $this->reg['new'] = $new;  }
    ...
    public function getEntity() { return $this->reg['entity']; }
    public function getOld() { return $this->reg['old']; }
    public function getNew() { return $this->reg['new']; }
