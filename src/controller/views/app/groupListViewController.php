...
class groupListViewController extends baseViewController
{
    private $table = 'group';
    ...
    /**
     * @Route('/app/groups', name='app_groups')
     */
    public function itemslistAction()
    {
//$this->myfile = fopen(APP_ROOT_PATH.'/var/logs/groupListViewController_'.__FUNCTION__.'.txt', 'a+') or die('Unable to open file!');
//$txt = '====================== '.__METHOD__.' start ==============================================================='.PHP_EOL;fwrite($this->myfile, $txt);
//$txt = 'this->pagination ========>'.PHP_EOL;fwrite($this->myfile, $txt);
//fwrite($this->myfile, print_r($this->pagination, TRUE));

        $this->list_filters['name']['caption'] = $this->lang['GROUP'];
        $this->list_filters['name']['placeholder'] = $this->lang['GROUP_NAME'];
...
//fclose($this->myfile);
        return $this->twig->render('app/'.$this->session->config['app_skin'].'/'.$this->folder.'/groups.html.twig', array(
