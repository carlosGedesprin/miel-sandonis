...
trait ragRepositoryController
{
     ...
     * @return void
     */
    public function createRag( $account, $billing_account, $product=NULL )
    {
...
//$txt = 'Rag '.$this->getId().' - '.$this->getDomainName().PHP_EOL; fwrite($this->myfile, $txt);
//fwrite($this->myfile, print_r( $this->getReg(), TRUE)); $txt = PHP_EOL; fwrite($this->myfile, $txt);
...
*/
        $this->setActive( '1' );
//$txt = 'Rag paid : '.$this->getId().PHP_EOL; fwrite($this->myfile, $txt);
//fwrite($this->myfile, print_r($this->getReg(), TRUE)); $txt = PHP_EOL; fwrite($this->myfile, $txt);
        $this->persistORL();
...
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
    ...
    public function createQLDescription( $locale, $date_start=NULL, $date_end=NULL )
    {
        $now = new DateTime('now', new DateTimeZone($this->session->config['time_zone']) );
//$txt = '====================== '.__METHOD__.' start ============= '.$now->format('d-m-Y  H:i:s').' ======================================================'.PHP_EOL; fwrite($this->myfile, $txt);
//$txt = 'Rag ('.$this->getId().') Start ('.(($date_start)? $date_start->format('d-m-Y') : '').') End ('.(($date_end)? $date_end->format('d-m-Y') : '').')'.PHP_EOL; fwrite($this->myfile, $txt);
...
//$txt = 'QL Description text '.$text_product.PHP_EOL; fwrite($this->myfile, $txt);
        ...
        //$text_rag = langTextController::getLangText( $this->utils, $locale,'RAG' );
        $text_rag = $text_product;
        ...
        $description = $text_rag.' '.$this->session->config['web_name'].': ';
