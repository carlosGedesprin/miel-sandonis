...
{
    use repository\workflowRepositoryController;
...
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
    ...
    public function setJson( $json ) { $this->reg['json'] = $json;  }
    public function setCredential( $credential ) { $this->reg['credentials'][] = $credential; }
    public function setActive( $active ) { $this->reg['active'] = $active;  }

    public function cleanCredentials() { $this->reg['credentials'] = array(); }
    ...
    public function getJson() { return $this->reg['json']; }
    public function getCredentials() { return $this->reg['credentials']; }
    ...
    {
//$txt = '====================== '.__METHOD__.' start ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
        $this->reg['credentials'] = ( empty($this->reg['credentials']) )? array() : explode( ',', $this->reg['credentials'] );
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
    }
    ...
    {
//$txt = '====================== '.__METHOD__.' start ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
        $this->reg['credentials'] = ( sizeof( $this->reg['credentials'] ) == 0 )? NULL : implode( ',', $this->reg['credentials'] );
