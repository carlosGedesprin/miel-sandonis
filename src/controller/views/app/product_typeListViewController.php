...
class product_typeListViewController extends baseViewController
{
    ...
    /**
     * @Route('/app/product_types', name='app_product_types')
     */
    public function itemslistAction()
    {
//$this->myfile = fopen(APP_ROOT_PATH.'/var/logs/product_typeListViewController_'.__FUNCTION__.'.txt', 'a+') or die('Unable to open file!');
//$txt = 'product_typeListViewController '.__FUNCTION__.' start ==============================================================='.PHP_EOL;fwrite($this->myfile, $txt);
//$txt = 'this->pagination ========>'.PHP_EOL;fwrite($this->myfile, $txt);
//fwrite($this->myfile, print_r($this->pagination, TRUE));
//$txt = 'product_typeListViewController '.__FUNCTION__.' end ==============================================================='.PHP_EOL;fwrite($this->myfile, $txt);
//fclose($this->myfile);
        $this->list_filters['name']['caption'] = $this->lang['PRODUCT_TYPE_NAME'];
        $this->list_filters['name']['placeholder'] = $this->lang['PRODUCT_TYPE_NAME'];
        ...
        return $this->twig->render('app/'.$this->session->config['app_skin'].'/'.$this->folder.'/product_types.html.twig', array(
