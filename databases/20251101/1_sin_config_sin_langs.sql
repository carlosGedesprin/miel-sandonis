...
(1, 'Altira Automations', 'Fondo editorial de la empresa Altira Automations', '/author/altira', 'blog_author_1_20251105163922.jpg', 'Logo de Altira Automations', 'https://www.linkedin.com/company/altira-automations', '1'),
(2, 'Carlos C. Gargallo', 'Nuestro CEO', '/author/carlos-c-gargallo', 'blog_author_1_20251105163922.jpg', 'No es mi mejor foto, ya lo se.', 'https://www.linkedin.com/in/carlos-c-gargallo/', '1');
...
(83, 1, 'es', '¿Qué procesos de mi negocio debo automatizar primero?', 'Recomendamos empezar por los procesos que son: a) repetitivos y de alto volumen, b) propensos a errores, y c) requieren mucho tiempo. Nuestro equipo de Altira puede ayudarle con una auditoría para identificar los puntos de mayor impacto.', 60, '1'),
...
(96, 3, 'en', 'Does AI Automation imply staff layoffs?', 'This is the biggest myth. AI Agents do not replace people; they replace repetitive, low-value tasks. Our focus at Altira is to free up your team to dedicate themselves to strategic, creative, and customer-facing tasks, where human value is irreplaceable.', 10, '1'),
(97, 3, 'en', 'What kind of security does Altira offer for my company\'s confidential data?', 'At Altira, we prioritize strict compliance with GDPR and other UK data security regulations. We implement controlled environment infrastructures, end-to-end encryption, and continuous auditing. Furthermore, the &quot;principle of least privilege&quot; ensures the AI Agent only accesses data essential for its task.', 30, '1'),
...
(100, 3, 'en', 'Does my team need advanced technical knowledge to use the AI?', 'No. Altira\'s solutions integrate into your existing systems with intuitive interfaces. Our job is to build the intelligence in the backend so your team only has to interact with the result simply and efficiently.', 90, '1'),
(101, 3, 'es', '¿La Automatización IA implica el despido de personal?', 'Es el mito más grande. Los Agentes IA no reemplazan personas; reemplazan tareas repetitivas y de bajo valor. Nuestro enfoque en Altira es liberar a su equipo para que se dedique a tareas estratégicas, creativas y de atención al cliente, donde el valor humano es irremplazable.', 20, '1'),
(102, 3, 'es', '¿Qué tipo de seguridad ofrece Altira para los datos confidenciales de mi empresa?', 'En Altira, priorizamos el cumplimiento estricto del RGPD y otras normativas de seguridad de datos. Implementamos infraestructuras de entorno controlado, encriptación de extremo a extremo y auditorías continuas. Además, el principio de &quot;mínimo privilegio&quot; asegura que el Agente IA solo acceda a los datos esenciales para su tarea.', 40, '1'),
...
(1, 'Altira Automations - Inicio',          'Página inicio',     NULL,        '/',            'weekly',     '0.9',      '2025-10-01', '1'),
(2, 'Altira Automations - Soluciones',      'Página soluciones', NULL,        '/soluciones', 'weekly',     '0.8',      '2025-10-01', '1'),
(3, 'Altira Automations - Conocenos',       'Página conocenos',  NULL,        '/conocenos',  'weekly',     '0.8',      '2025-10-01', '1'),
(4, 'Altira Automations - Blog',            'Página blog',       NULL,        '/blog',       'weekly',     '0.8',      '2025-10-01', '1'),
(5, 'Altira Automations - Sectores',        'Página sectores',   NULL,        '/sectores',   'weekly',     '0.8',      '2025-10-01', '0'),
(6, 'Altira Automations - Contacto',        'Página contacto',   NULL,        '/contacto',   'weekly',     '0.8',      '2025-10-01', '1');
