...
class N8NWarmIPAccountListViewController extends baseViewController
{
    private $table = 'n8n_warm_ip_account';
    ...
    /**
     * @Route('/app/n8n_warm_ip_accounts', name='app_n8n_warm_ip_accounts')
     */
    public function itemslistAction()
    {
//$this->myfile = fopen(APP_ROOT_PATH.'/var/logs/n8n_warm_ip_accountListViewController_'.__FUNCTION__.'.txt', 'w') or die('Unable to open file!');
//$txt = '====================== '.__METHOD__.' start ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
//$txt = 'this->pagination ========>'.PHP_EOL;fwrite($this->myfile, $txt);
//fwrite($this->myfile, print_r($this->pagination, TRUE));
        $this->list_filters['name']['caption'] = $this->lang['N8N_WARM_IP_ACCOUNT_NAME'];
        $this->list_filters['name']['placeholder'] = $this->lang['N8N_WARM_IP_ACCOUNT_NAME'];
...
//fclose($this->myfile);
        return $this->twig->render('app/'.$this->session->config['app_skin'].'/'.$this->folder.'/N8N_warm_ip_accounts.html.twig', array(
