...
class n8NleadEmailController extends baseController
{
    use repository\N8NleadEmailRepositoryController;

    private $table = 'lead_n8n_email';
    private $reg = array(
                            'id'          => '',
                            'lead'        => NULL,
                            'date_sent'   => NULL,
...
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
    ...
    public function setLead( $lead ) { $this->reg['lead'] = $lead;  }
    ...
    public function getLead() { return $this->reg['lead']; }
