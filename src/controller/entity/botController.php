...
{
    use repository\botRepositoryController;
...
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
    ...
    public function setUserAgent( $useragent ) { $this->reg['user_agent'] = $useragent;  }
    ...
    public function getUserAgent() { return $this->reg['user_agent']; }
