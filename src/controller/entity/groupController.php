...
{
    use repository\groupRepositoryController;
    use verifications\groupVerificationController;
...
//$txt = '====================== '.__METHOD__.' start ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
        ...
        $this->reg['show_to_staff'] = ( $this->reg['show_to_staff'] == '0' )? NULL : $this->reg['show_to_staff'];
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
    }
}
