...
class leadOriginController extends baseController
{
    use repository\leadOriginRepositoryController;
...
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
    ...
    public function setLangKey( $name ) { $this->reg['lang_key'] = $name;  }
    ...
    public function getLangKey() { return $this->reg['lang_key']; }
