...
class spammerController extends baseController
{
    use repository\spammerRepositoryController;
...
//fwrite($this->myfile, print_r($this->reg, TRUE)); $txt = PHP_EOL; fwrite($this->myfile, $txt);
        ...
        if ( $this->reg['name'] == '' && $this->reg['email'] == '' && $this->reg['remote_addr'] == '' && $this->reg['http_x_forwarded_for'] == '' ) return NULL;
...
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
    ...
    public function setRemoteAddr( $remote_addr ) { $this->reg['remote_addr'] = $remote_addr;  }
    public function setHttpXForwardedFor( $http_x_forwarded_for ) { $this->reg['http_x_forwarded_for'] = $http_x_forwarded_for;  }
    ...
    public function getRemoteAddr() { return $this->reg['remote_addr']; }
    public function getHttpXForwardedFor() { return $this->reg['http_x_forwarded_for']; }
