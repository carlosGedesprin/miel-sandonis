<?php
//$myfile_account_customer = fopen(APP_ROOT_PATH.'/var/logs/viewSelects_account_customer.txt', 'w') or die('Unable to open file!');
//$txt = 'viewSelects_account_customer start ==============================================================='.PHP_EOL; fwrite($myfile_account_customer, $txt);
...
foreach ( $rows as $row )
{
    ...
    $data['account_options'] .= $row['id'].' - '.$row['name'].( ($row['active'] == '0' )? ' ('.$this->lang['ACCOUNT_NOT_ACTIVE'].')' : '' );
