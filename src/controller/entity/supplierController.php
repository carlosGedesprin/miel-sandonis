...
{
    use repository\supplierRepositoryController;
    use verifications\supplierVerificationController;
...
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
    ...
    /**
     *
     * Get supplier from his supplier key
     *
     */
    public function getRegbySupplierKey( $supplier_key )
    {
//$txt = '====================== '.__METHOD__.' start ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
//$txt = 'Supplier key ==========> ('.$supplier_key.')'.PHP_EOL; fwrite($this->myfile, $txt);
        $filter = array( 'supplier_key' => $supplier_key  );
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
        return $this->getRegFromDB( $filter );
    }
...
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
    ...
    public function setSupplierKey( $supplier_key ) { $this->reg['supplier_key'] = $supplier_key;  }
    ...
    public function getSupplierKey() { return $this->reg['supplier_key']; }
