...
{
    use repository\productTypeRepositoryController;
...
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
    ...
    public function setNameKey( $name_key ) { $this->reg['name_key'] = $name_key;  }
    public function setTable( $table ) { $this->reg['table'] = $table;  }
    public function setController( $controller ) { $this->reg['controller'] = $controller;  }
    public function setHasAutoRenew( $has_auto_renew ) { $this->reg['has_auto_renew'] = $has_auto_renew;  }
    ...
    public function getNameKey() { return $this->reg['name_key']; }
    public function getTable() { return $this->reg['table']; }
    public function getController() { return $this->reg['controller']; }
    public function getHasAutoRenew() { return $this->reg['has_auto_renew']; }
...
//$txt = '====================== '.__METHOD__.' start ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
        ...
        $this->reg['name_key'] = ( empty($this->reg['name_key']) )? NULL : $this->reg['name_key'];
        $this->reg['table'] = ( empty($this->reg['table']) )? NULL : $this->reg['table'];
        $this->reg['controller'] = ( empty($this->reg['controller']) )? NULL : $this->reg['controller'];
        $this->reg['has_auto_renew'] = ( empty($this->reg['has_auto_renew']) )? '0' : $this->reg['has_auto_renew'];
