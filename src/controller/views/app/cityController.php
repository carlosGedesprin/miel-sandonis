...
{
    use repository\cityRepositoryController;
...
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
    ...
    /**
     *
     * Get city from city_code
     *
     */
    public function getRegbyCityCode( $city_code )
    {
//$txt = '====================== '.__METHOD__.' start ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
//$txt = 'City code ==========> ('.$city_code.')'.PHP_EOL; fwrite($this->myfile, $txt);
        if ( !$city_code ) return false;

        $route = '/get_city_by_city_code';
        $api_data = array(
                            'city_code' => $city_code,
        );
...
//fwrite($this->myfile, print_r($result, TRUE)); $txt = PHP_EOL; fwrite($this->myfile, $txt);
        ...
        $this->setCityCode( $result['msg']['city_code'] );
