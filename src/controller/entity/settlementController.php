...
{
    use repository\settlementRepositoryController;
...
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
    ...
    /**
     *
     * Get user from his account and date
     *
     */
    public function getRegbyAccountAndDate( $account, $date )
    {
//$txt = '====================== '.__METHOD__.' start ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
//$txt = 'Id ====> ('.$id.') Date ('.$date->format('Y-m-d').')'PHP_EOL; fwrite($this->myfile, $txt);
        if ( !$account || !$date ) return false;

        $filter = array( 'account' => $account, 'date' => $date->format('Y-m-d')  );
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
        return $this->getRegFromDB( $filter );
    }
...
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
    ...
    public function setVatAmount( $vat_amount ) { $this->reg['vat_amount'] = $vat_amount;  }
    public function setTotalToPay( $total_to_pay ) { $this->reg['total_to_pay'] = $total_to_pay;  }
...
//$txt = '====================== '.__METHOD__.' start ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
        ...
        $this->reg['payed'] = ( empty($this->reg['payed']) )? '0' : $this->reg['payed'];
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
    }
}