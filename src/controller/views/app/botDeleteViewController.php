...
class botDeleteViewController extends baseViewController
{
    ...
    /**
     * @Route("/app/bot/delete/id", name="app_bot_delete")
     *
    ...
    {
//$this->myfile = fopen(APP_ROOT_PATH.'/var/logs/botDeleteViewController_'.__FUNCTION__.'.txt', 'w') or die('Unable to open file!');
//$txt = '====================== '.__METHOD__.' start ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);

        $form_action = $this->folder.'/bot/delete';
        ...
        if ( !isset( $vars['id']) || $vars['id'] == '' || $vars['id'] == '0' )
        {
            $_SESSION['alert'] = array(
                'type'          => 'danger',
                'message'       => $this->lang['ERR_BOT_NOT_EXISTS'],
        ...
        if ( $data['submit'] )
        {
            ...
            */
            ...
            {
                $this->logger->info('==============='.__METHOD__.' Bot '.$vars['id'].' | User '.$this->user.' ===================================================');
                ...
                $response['status'] = 'OK';
                $response['msg'] = $this->lang['BOT_DELETED'];
