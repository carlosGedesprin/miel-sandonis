...
class botListViewController extends baseViewController
{
    private $table = 'bot';
...
//fwrite($this->myfile, print_r($this->pagination, TRUE));
        $this->list_filters['name']['caption'] = $this->lang['BOT_NAME'];
        $this->list_filters['name']['placeholder'] = $this->lang['BOT_NAME'];
...
//fclose($this->myfile);
        return $this->twig->render('app/'.$this->session->config['app_skin'].'/'.$this->folder.'/bots.html.twig', array(
