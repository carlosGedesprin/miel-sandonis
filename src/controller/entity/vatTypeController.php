...
{
    use repository\vatTypeRepositoryController;
...
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
    ...
    public function setPercent( $percent ) { $this->reg['percent'] = $percent;  }
    ...
    public function getPercent() { return $this->reg['percent']; }
...
//$txt = '====================== '.__METHOD__.' start ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
        ...
        $this->reg['percent'] = ( empty($this->reg['percent']) ) ? '0' : $this->reg['percent'];
