...
class cronListViewController extends baseViewController
{
    private $table = 'cron';
    ...
    /**
     * @Route('/app/crons', name='app_crons')
     */
    public function itemslistAction()
    {
//$this->myfile = fopen(APP_ROOT_PATH.'/var/logs/cronListViewController_'.__FUNCTION__.'.txt', 'w') or die('Unable to open file!');
//$txt = 'cronListViewController '.__FUNCTION__.' start ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
//$txt = 'this->pagination ========>'.PHP_EOL;fwrite($this->myfile, $txt);
//fwrite($this->myfile, print_r($this->pagination, TRUE));
//$txt = 'cronListViewController '.__FUNCTION__.' end ==============================================================='.PHP_EOL;fwrite($this->myfile, $txt);
//fclose($this->myfile);
        $this->list_filters['process']['caption'] = $this->lang['CRON'];
        $this->list_filters['process']['placeholder'] = $this->lang['CRON_PROCESS'];
        ...
        return $this->twig->render('app/'.$this->session->config['app_skin'].'/'.$this->folder.'/crons.html.twig', array(
