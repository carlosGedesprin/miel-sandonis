...
class accountFundsController extends baseController
{
    use repository\accountFundsRepositoryController;
...
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
    ...
    /**
     *
     * Get account funds from his funding_key
     *
     */
...
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
    ...
    public function setCredit( $credit ) { $this->reg['credit'] = $credit;  }
    public function setDebit( $debit ) { $this->reg['debit'] = $debit;  }
    ...
    public function getCredit() { return $this->reg['credit']; }
    public function getDebit() { return $this->reg['debit']; }
...
//$txt = '====================== '.__METHOD__.' start ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
        ...
        $this->reg['credit'] = ( empty($this->reg['credit']) )? NULL : $this->reg['credit'];
        $this->reg['debit'] = ( empty($this->reg['debit']) )? NULL : $this->reg['debit'];
