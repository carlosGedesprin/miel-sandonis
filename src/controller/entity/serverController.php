...
{
    use repository\serverRepositoryController;
    use verifications\serverVerificationController;
...
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
     ...
     *
     */
    public function getRegbyServerKey( $key )
    {
//$txt = '====================== '.__METHOD__.' start ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
//$txt = 'Key ==========> ('.$key.')'.PHP_EOL; fwrite($this->myfile, $txt);
        if ( !$key ) return false;

        $filter = array( 'server_key' => $key  );
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
        return $this->getRegFromDB( $filter );
    }
...
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
    ...
    public function setServerKey( $server_key ) { $this->reg['server_key'] = $server_key; }
    ...
    public function setServerName( $server_name ) { $this->reg['server_name'] = $server_name; }
    public function setIP( $ip ) { $this->reg['ip'] = $ip; }
    public function setServerId( $server_id ) { $this->reg['server_id'] = $server_id; }
    public function setRootPassword( $root_password ) { $this->reg['root_password'] = $root_password; }
    ...
    public function setCustomerUsername( $customer_username ) { $this->reg['customer_username'] = $customer_username; }
    public function setCustomerPassword( $customer_password ) { $this->reg['customer_password'] = $customer_password; }
    public function setService( $service ) { $this->reg['services'][] = $service; }
    ...
    public function cleanServices() { $this->reg['services'] = array(); }
    ...
    public function getServerKey() { return $this->reg['server_key']; }
    ...
    public function getServerName() { return $this->reg['server_name']; }
    public function getIP() { return $this->reg['ip']; }
    public function getServerId() { return $this->reg['server_id']; }
    public function getRootPassword() { return $this->reg['root_password']; }
    public function getUsername() { return $this->reg['username']; }
    public function getPassword() { return $this->reg['password']; }
    public function getCustomerUsername() { return $this->reg['customer_username']; }
    public function getCustomerPassword() { return $this->reg['customer_password']; }
    public function getServices() { return $this->reg['services']; }
...
//$txt = '====================== '.__METHOD__.' start ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
        ...
        $this->reg['services'] = ( empty($this->reg['services']) )? array() : explode( ',', $this->reg['services'] );
        $this->reg['bulk_info'] = ( empty($this->reg['bulk_info']) )? NULL : unserialize( $this->reg['bulk_info'] );
//$txt = '====================== '.__METHOD__.' end ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
    }
...
//$txt = '====================== '.__METHOD__.' start ==============================================================='.PHP_EOL; fwrite($this->myfile, $txt);
        ...
        $this->reg['services'] = ( sizeof( $this->reg['services'] ) == 0 )? NULL : implode( ',', $this->reg['services'] );

        $this->reg['server_name'] = ( empty($this->reg['server_name']) )? NULL : $this->reg['server_name'];
        $this->reg['bulk_info'] = ( empty($this->reg['bulk_info']) )? NULL : serialize( $this->reg['bulk_info'] );
